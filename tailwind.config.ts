	...
	theme: {
		...
		extend: {
			...
			animation: {
				...
				'scanner-line': 'scanner-line 5s linear infinite',
			...
			backgroundImage: {
				'hero-skull': "url('/lovable-uploads/97d47601-69f2-42b9-8dac-5344f007c744.png')",
				'skull-green': "url('/lovable-uploads/8b875df2-119e-4140-918c-0f663f8c3fc1.png')",
